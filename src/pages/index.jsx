  ...
  return (
    <div>
      ...
      <div className="frontpage-row">
        <p className="subtitle">a second-year computer science student at Simon Fraser University,
      ...
      <p className="pop-in-text justify-self-center">Scroll down for more</p>
      <BackgroundShaderViewport/>
      <div className="frontpage-row display-flex-row">
